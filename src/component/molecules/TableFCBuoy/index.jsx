            ...
            <table className="min-w-full bg-white divide-y divide-gray-200">
              <thead className="bg-[#2E3192] text-white text-bold">
                <tr>
                  ...
                  <th className="text-center px-6 py-3 text-xs font-bold text-left capitalize">Latitude</th>
                  <th className="text-center px-6 py-3 text-xs font-bold text-left capitalize">Longtidude</th>
                  <th className="text-center px-6 py-3 text-xs font-bold text-left capitalize">Roll</th>
                  <th className="text-center px-6 py-3 text-xs font-bold text-left capitalize">Pitch</th>
                  <th className="text-center px-6 py-3 text-xs font-bold text-left capitalize">Yaw</th>
                  <th className="text-center px-6 py-3 text-xs font-bold text-left capitalize">Kompas</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200">
                {dataFCBuoy?.result?.slice().reverse().map((item, i) => (
                  <tr key={i}>
