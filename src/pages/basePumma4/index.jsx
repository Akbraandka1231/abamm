...
const Index = ({
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("https://c-greenproject.org:4443/marinaj/latest");
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("https://c-greenproject.org:4443/marinaj/image", {
                ...
                <TabGroup>
                  ...
                  <TabPanels>
                    ...
                    <TabPanel>
                      ...
                      <p className="py-2 pb-3 text-xl font-normal">Marina Jambu</p>
                    ...
                    <TabPanel>
                      ...
                      <p className="py-1 text-xl font-normal">Marina Jambu</p>
                      <div className=" px-3 py-3 w-full  flex items-center rounded-sm">
                        <div className="w-[100%] h-[100%] overflow-hidden">
                        <SimpleMap latitude={-6.1890307} longitude={105.8406540} />
                        </div>
                      </div>
                      <div className=" px-3 py-3  flex items-center rounded-sm">
                        <div className="w-full ">
