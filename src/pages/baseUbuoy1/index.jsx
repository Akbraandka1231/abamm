                          ...
                          <div className="border bg-white drop-shadow-lg rounded-lg px-3 flex items-center md:w-[19rem] w-[15rem] h-36">
                            <div className="w-full">
                              ...
                              <div className="md:text-3xl text-xl font-semibold justify-between flex space-x-5 items-center">
                                ...
                                >
                                  <path
                                    d="M57 114C29.374 114 0 104.538 0 86.9904C0 85.885 0.400356 84.8248 1.11299 84.0431C1.82563 83.2614 2.79218 82.8223 3.8 82.8223C4.80782 82.8223 5.77437 83.2614 6.48701 84.0431C7.19964 84.8248 7.6 85.885 7.6 86.9904C7.6 95.827 28.728 105.664 57 105.664C85.272 105.664 106.4 95.827 106.4 86.9904C106.4 85.885 106.8 84.8248 107.513 84.0431C108.226 83.2614 109.192 82.8223 110.2 82.8223C111.208 82.8223 112.174 83.2614 112.887 84.0431C113.6 84.8248 114 85.885 114 86.9904C114 104.538 84.626 114 57 114Z"
                                    fill="#DDDDDD"
                                    fill-opacity="0.5"
                                  />
                                  <path
                                    d="M110.2 91.1562H3.8C2.79218 91.1562 1.82563 90.7171 1.11299 89.9354C0.400356 89.1537 0 88.0935 0 86.9881C0 85.8826 0.400356 84.8224 1.11299 84.0407C1.82563 83.259 2.79218 82.8199 3.8 82.8199H110.2C111.208 82.8199 112.174 83.259 112.887 84.0407C113.6 84.8224 114 85.8826 114 86.9881C114 88.0935 113.6 89.1537 112.887 89.9354C112.174 90.7171 111.208 91.1562 110.2 91.1562ZM83.6 73.8583H30.4C29.6033 73.9266 28.8073 73.7176 28.1251 73.2612C27.4429 72.8047 26.9092 72.1239 26.6 71.3157C22.645 61.1047 20.8146 50.0551 21.242 38.9706C21.5677 30.0419 23.3837 21.2545 26.6 13.0445C26.9092 12.2363 27.4429 11.5555 28.1251 11.0991C28.8073 10.6426 29.6033 10.4336 30.4 10.5019H83.6C84.1803 10.5035 84.7526 10.6508 85.273 10.9325C85.7934 11.2143 86.248 11.6231 86.602 12.1275C86.9573 12.6285 87.2036 13.2118 87.3221 13.833C87.4407 14.4542 87.4283 15.097 87.286 15.7122C83.3373 33.1058 83.3373 51.2961 87.286 68.6897C87.4223 69.2987 87.4316 69.9335 87.3131 70.547C87.1947 71.1604 86.9516 71.7366 86.602 72.2327C86.248 72.7371 85.7934 73.1459 85.273 73.4277C84.7526 73.7094 84.1803 73.8568 83.6 73.8583ZM32.794 65.5219H79.002C76.1636 50.1164 76.1636 34.2438 79.002 18.8383H32.794C30.5385 25.3937 29.2556 32.3032 28.994 39.3041C28.6544 48.2338 29.9464 57.148 32.794 65.5219Z"
                                    fill="#DDDDDD"
                                    fill-opacity="0.5"
                                  />
                                  <path
                                    d="M57 89.9077C55.9921 89.9077 55.0256 89.4685 54.3129 88.6868C53.6003 87.9052 53.2 86.845 53.2 85.7395V70.6507C53.2 69.5452 53.6003 68.485 54.3129 67.7033C55.0256 66.9216 55.9921 66.4825 57 66.4825C58.0078 66.4825 58.9743 66.9216 59.687 67.7033C60.3996 68.485 60.8 69.5452 60.8 70.6507V85.7395C60.8 86.845 60.3996 87.9052 59.687 88.6868C58.9743 89.4685 58.0078 89.9077 57 89.9077ZM57 18.5067C55.9921 18.5067 55.0256 18.0676 54.3129 17.2859C53.6003 16.5042 53.2 15.444 53.2 14.3385V4.16818C53.2 3.06271 53.6003 2.00252 54.3129 1.22083C55.0256 0.439146 55.9921 0 57 0C58.0078 0 58.9743 0.439146 59.687 1.22083C60.3996 2.00252 60.8 3.06271 60.8 4.16818V14.3385C60.8 15.444 60.3996 16.5042 59.687 17.2859C58.9743 18.0676 58.0078 18.5067 57 18.5067Z"
                                    fill="#DDDDDD"
                                    fill-opacity="0.5"
                                  />
                                </svg>
