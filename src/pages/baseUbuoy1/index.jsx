                ...
                <TabGroup>
                  ...
                  <TabPanels>
                    <TabPanel>
                      ...
                      <p className="py-4 mb-3 md:text-xl text-base font-normal">EWS Buoy</p>
                      <div className="px-4">
                        ...
                        <div className="md:mx-5 space-y-9 sm:grid sm:grid-cols-2 sm:gap-5 sm:space-y-0  md:justify-start md:gap-5 md:flex md:flex-wrap">
                          <div className="border bg-white drop-shadow-lg rounded-lg px-3 flex items-center md:w-[19rem] w-[15rem] h-36">
                            <div className="w-full">
                              <div className="flex space-x-4 items-center">
                                <p className="font-semibold md:text-xl text-lg">Roll</p>
                              </div>
                              <div className="md:text-3xl text-xl font-semibold justify-between flex space-x-5 items-center">
                                <p>{`0.71 °`}</p>
                          ...
                          <div className="border bg-white drop-shadow-lg rounded-lg px-3 flex items-center md:w-[19rem] w-[15rem] h-36">
                            <div className="w-full">
                              <div className="flex space-x-4 items-center">
                                <p className="font-semibold md:text-xl text-lg">Pitch</p>
                              </div>
                              <div className="pt-2 md:text-3xl text-xl font-semibold justify-between flex space-x-5 items-center">
                                <p>{`-4.39 °`}</p>
                          ...
                          <div className="border bg-white drop-shadow-lg rounded-lg px-3 flex items-center md:w-[19rem] w-[15rem] h-36">
                            <div className="w-full">
                              <div className="flex space-x-4 items-center">
                                <p className="font-semibold md:text-xl text-lg">Yaw</p>
                              </div>
                              <div className="pt-2 md:text-3xl text-xl font-semibold justify-between flex space-x-5 items-center">
                                <p>{`342.9 °`}</p>
                          ...
                          <div className="border bg-white drop-shadow-lg rounded-lg px-3 flex items-center md:w-[19rem] w-[15rem] h-36">
                            <div className="w-full">
                              <div className="flex space-x-4 items-center">
                                <p className="font-semibold md:text-xl text-lg">Kompas</p>
                              </div>
                              <div className="md:text-3xl text-xl font-semibold justify-between flex space-x-5 items-center">
                                <p>{`18 °`}</p>
                    ...
                    <TabPanel>
                      <h1 className="py-2 font-bold md:text-2xl text-lg">Ubuoy 001</h1>
                      <p className="py-4 mb-3 md:text-xl text-base font-normal">EWS Buoy</p>
