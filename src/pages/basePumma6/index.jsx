...
const Index = ({
  ...
  const [dataChartClimate, setDataChartClimate] = useState([]);
  const [dataChartSerial, setDataChartSerial] = useState([]);
  const [dataChartDevice, setDataChartDevice] = useState([]);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setDataChartClimate(responseDataChart.data);
        console.log("Response data:", responseDataChart.data);
        console.log("Current timeFrame:", timeFrame);
      } catch (err) {
        console.log("Error fetching data:", err.message);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setDataChartDevice(responseDataChart.data);
        console.log("Response data:", responseDataChart.data);
        console.log("Current timeFrame:", timeFrame);
      } catch (err) {
        console.log("Error fetching data:", err.message);
                ...
                <TabGroup>
                  ...
                  <TabPanels>
                    <TabPanel>
                      ...
                      <p className="py-2 mb-3 md:text-xl text-base font-semibold">
                        Pulau Sebesi
                      </p>
                      ...
                      <div className="md:px-16 md:mx-5 space-y-9 sm:grid sm:grid-cols-2 sm:gap-5 sm:space-y-0  md:justify-start md:gap-5 md:flex md:flex-wrap">
                            ...
                            <div className="w-full">
                              ...
                              <div className="pt-2 md:text-3xl text-xl font-semibold justify-between flex space-x-5 items-center">
                                {dataPummaSebesi.Water_level_Pressure && (
                                  <p>{`${dataPummaSebesi.Water_level_Pressure} m`}</p>
                                )}
                                <svg
                                  width="90"
                                  height="80"
                          ...
                          <div className="w-full">
                            ...
                            <div className="pt-2 md:text-3xl text-xl font-semibold justify-between flex space-x-5 items-center">
                              {dataPummaSebesi.Alert_Signal && (
                                <p>{`${dataPummaSebesi.Alert_Signal} m`}</p>
                              )}
                              <svg
                                width="90"
                                height="80"
                        ...
                        <div className="border bg-white drop-shadow-lg rounded-lg px-3 flex items-center md:w-[19rem] w-[15rem] h-36">
                          <div className="w-full">
                            ...
                            <div className="pt-2 md:text-3xl text-xl font-semibold justify-between flex space-x-5 items-center">
                              {dataPummaSebesi.Threshold && (
                                <p>{`${dataPummaSebesi.Threshold}`}</p>
                              )}
                              <svg
                                width="90"
                                height="80"
                        ...
                        <div className="border bg-white drop-shadow-lg rounded-lg px-3 flex items-center md:w-[19rem] w-[15rem] h-36">
                          <div className="w-full">
                            ...
                            <div className="pt-2 md:text-3xl text-xl font-semibold justify-between flex space-x-5 items-center">
                              {dataPummaSebesi.Alert_Level && (
                                <p>{`${dataPummaSebesi.Alert_Level}`}</p>
                              )}
                              <svg
                                width="90"
                                height="80"
                        ...
                        <div className="border bg-white drop-shadow-lg rounded-lg px-3 flex items-center md:w-[19rem] w-[15rem] h-36">
                          <div className="w-full">
                            ...
                            <div className="pt-2 md:text-3xl text-xl font-semibold justify-between flex space-x-5 items-center">
                              {typeof dataPummaSebesi.Alert_Level !==
                                "undefined" && (
                                <p
                                  className={`${
                      ...
                      <div className="border bg-white drop-shadow-lg rounded-lg px-3 flex items-center md:w-[19rem] w-[15rem] h-36">
                        ...
                        <div className="border bg-white drop-shadow-lg rounded-lg px-3 flex items-center md:w-[19rem] w-[15rem] h-36">
                          <div className="w-full">
                            ...
                            <div className="md:text-3xl text-xl font-semibold justify-between flex space-x-5 items-center">
                              {dataClimate.Temperature && (
                                <p>{`${dataClimate.Temperature}`}</p>
                              )}
                              <svg
                                width="100"
                                height="87"
                        ...
                        <div className="border bg-white drop-shadow-lg rounded-lg px-3 flex items-center md:w-[19rem] w-[15rem] h-36">
                          <div className="w-full">
                            ...
                            <div className="md:text-3xl text-xl font-semibold justify-between flex space-x-5 items-center">
                              {dataClimate.SolarRadiation && (
                                <p>{`${dataClimate.SolarRadiation}`}</p>
                              )}
                              <svg
                                width="100"
                                height="87"
                          ...
                          <div className="w-full">
                            ...
                            <div className="pt-2 md:text-3xl text-xl font-semibold drop-shadow-lg justify-between flex space-x-5 items-center">
                              {dataClimate.AirPressure && (
                                <p>{`${dataClimate.AirPressure} hpa`}</p>
                              )}
                              <svg
                                width="78"
                                height="90"
                      ...
                      <div className="md:px-16 md:mx-5 space-y-9 sm:grid sm:grid-cols-2 sm:gap-5 sm:space-y-0  md:justify-start md:gap-5 md:flex md:flex-wrap">
                        ...
                        <div className="border bg-white drop-shadow-lg rounded-lg px-3 flex items-center md:w-[19rem] w-[15rem] h-36">
                          <div className="w-full">
                            ...
                            <div className="pt-2 md:text-3xl text-xl font-semibold justify-between flex space-x-5 items-center">
                              {dataDevice.device_current && (
                                <p>{`${dataDevice.device_current} A`}</p>
                              )}
                              <svg
                                width="90"
                                height="80"
                        ...
                        <div className="border bg-white drop-shadow-lg rounded-lg px-3 flex items-center md:w-[19rem] w-[15rem] h-36">
                          <div className="w-full">
                            ...
                            <div className="pt-2 md:text-3xl text-xl font-semibold justify-between flex space-x-5 items-center">
                              {dataDevice.device_power && (
                                <p>{`${dataDevice.device_power} `}</p>
                              )}
                              <svg
                                width="90"
                                height="80"
                    ...
                    <TabPanel>
                      ...
                      <p className="py-1 md:text-xl text-lg font-bold text-[#2E3192] py-3">
                        Pumma Water Pressure
                      </p>
                      ...
                      <p className="py-1 md:text-xl text-font-bold text-[#2E3192] py-3">
                        Pumma Maxbotic
                      </p>
                      <div className="grid text-center">
                      ...
                      <div className="grid md:grid-cols-2 md:gap-5">
                        <div className=" md:px-3 md:py-3  md:flex items-center rounded-sm">
                          <div aria-label="waterlevel" className="w-full">
                            <CartSebesi data={dataChart} keys={["Water_level_Pressure", "For30", "For300"]}/>
                          </div>
                        </div>
                        <div className=" md:px-3 md:py-3  md:flex items-center rounded-sm">
                          <div aria-label="waterlevel" className="w-full">
                            <CartSebesi data={dataChart} keys={["Alert_Level", "Threshold", "rms"]}/>
                          </div>
                        </div>
                        <div className=" md:px-3 md:py-3  md:flex items-center rounded-sm">
                          <div aria-label="waterlevel" className="w-full">
                            <CartSebesi data={dataChartClimate} keys={["Humidity", "Temperature"]}/>
                          </div>
                        </div>
                        <div className=" md:px-3 md:py-3  md:flex items-center rounded-sm">
                          <div aria-label="waterlevel" className="w-full">
                            <CartSebesi data={dataChartClimate} keys={["SolarRadiation", "AirPressure"]}/>
                          </div>
                        </div>
                        <div className=" md:px-3 md:py-3  md:flex items-center rounded-sm">
                          <div aria-label="waterlevel" className="w-full">
                            <CartSebesi data={dataChartSerial} keys={["maxbotic2"]}/>
                          </div>
                        </div>
                        <div className=" md:px-3 md:py-3  md:flex items-center rounded-sm">
                          <div aria-label="waterlevel" className="w-full">
                            <CartSebesi data={dataChartDevice} keys={["battery_voltage", "raspi_temperature","pv_voltage"]}/>
                          </div>
                        </div>
