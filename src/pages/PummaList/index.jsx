                ...
                {dataPumma?.map((item, i) => {
                  return (
                      <div
                        ...
                        <h1 className="max-[375px]:text-xs min-[450px]:text-lg min-[450px]:text-lg font-semibold sm:text-base text-sm">{item.name1}</h1>
                        ...
                        <h1 className="max-[375px]:text-xs min-[450px]:text-lg font-semibold sm:text-base text-sm">{item.name3}</h1>
                        <p className="min-[450px]:text-base font-normal md:text-sm text-xs">{item.nameLocation3}</p>

                        <h1 className="max-[375px]:text-xs min-[450px]:text-lg font-semibold sm:text-base text-sm">{item.name4}</h1>
                        <p className="min-[450px]:text-base font-normal md:text-sm text-xs">{item.nameLocation4}</p>
